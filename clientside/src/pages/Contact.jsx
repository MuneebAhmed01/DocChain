        ...
        <div className="container mx-auto px-6 lg:px-20 py-12 grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="lg:col-span-3 space-y-6 pt-6">
            ...
            <p className="text-sm text-gray-600 max-w-lg">
              Have questions about booking an appointment, consulting online, or
              finding the right specialist? Our team is ready to help.
            </p>
            ...
            <div className="mt-4 text-sm text-gray-700">
              ...
              <a
                ...
                href="mailto:support@docchain.com"
              >
                Email Support
              </a>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-gray-600">
              <div>
                ...
                <p className="mt-2">
                  Need help scheduling or managing a consultation? Our support
              ...
              <div>
                ...
                <p className="mt-2">
                  Looking for a specialist or want to join our network? Contact
                  us for detailed information and next steps.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2">
                  We welcome your feedback to improve patient experience and
                  service quality.
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 flex justify-center">
            <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8 w-full max-w-lg">
              <h2 className="text-xl lg:text-2xl font-bold mt-0">
                Get in Touch
              </h2>
